...
! function($) {
    ...
    Datepicker.prototype = {
        ...
        show: function(e) {
            var toIntValue = function(value) {
                if (isNaN(value)) {
                    return value.outerHeight(false);
                }
            ...
            if (this.component) {
                this.height = toIntValue(this.component.outerHeight());
            } else {
                this.height = toIntValue(this.element.outerHeight());
            }
