...
/**
 * A context relative resource that uses {@link SassResourceStream} to
 * compile it to CSS
 */
public class ContextRelativeSassResource extends ContextRelativeResource {
     ...
     * Constructor.
     *
     * @param path The path to the LESS resource in the servlet context
     */
    ...
    protected ResourceResponse newResourceResponse(final Attributes attributes)
    {
        ...
        try {
            ...
            final SassResourceStream webExternalResourceStream = new SassResourceStream(urlResourceStream, ContextRelativeSassResource.class.getName());
