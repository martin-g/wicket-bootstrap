...
* Twitter Bootstrap (2.3.1-1): http://twitter.github.com/bootstrap
* Apache Wicket (6.8.0): http://wicket.apache.org/
...
* less4j (1.0.3): https://github.com/SomMeri/less4j
...
## Maven
wicket-bootstrap is [available](http://search.maven.org/#artifactdetails|de.agilecoders.wicket|wicket-bootstrap-core|0.8.3|jar) in Maven central repository.
