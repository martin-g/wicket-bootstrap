...
public abstract class BootstrapOrderByBorder<S> extends Border {
	 ...
	 * @param property the property to be sorted on
	 * @param stateLocator the state locator
	 * @param cssProvider a custom css provider
	 */
	public BootstrapOrderByBorder(final String id, final S property, final ISortStateLocator<S> stateLocator, final OrderByLink.ICssProvider<S> cssProvider) {
		super(id);
