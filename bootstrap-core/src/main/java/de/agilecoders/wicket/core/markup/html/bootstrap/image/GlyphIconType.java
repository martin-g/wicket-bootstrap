...
public class GlyphIconType extends IconType {
    ...
    public static final GlyphIconType alert = new GlyphIconType("alert");
    ...
    public static final GlyphIconType apple = new GlyphIconType("apple");
    ...
    public static final GlyphIconType babyformula = new GlyphIconType("baby-formula");
    ...
    public static final GlyphIconType bed = new GlyphIconType("bed");
    public static final GlyphIconType bell = new GlyphIconType("bell");
    public static final GlyphIconType bishop = new GlyphIconType("bishop");
    public static final GlyphIconType bitcoin = new GlyphIconType("bitcoin");
    public static final GlyphIconType blackboard = new GlyphIconType("blackboard");
    ...
    public static final GlyphIconType cd = new GlyphIconType("cd");
    ...
    public static final GlyphIconType copy = new GlyphIconType("copy");
    ...
    public static final GlyphIconType duplicate = new GlyphIconType("duplicate");
    ...
    public static final GlyphIconType education = new GlyphIconType("education");
    ...
    public static final GlyphIconType equalizer = new GlyphIconType("equalizer");
    public static final GlyphIconType erase = new GlyphIconType("erase");
    ...
    public static final GlyphIconType grain = new GlyphIconType("grain");
    ...
    public static final GlyphIconType hourglass = new GlyphIconType("hourglass");
    public static final GlyphIconType icelolly = new GlyphIconType("ice-lolly");
    public static final GlyphIconType icelollytasted = new GlyphIconType("ice-lolly-tasted");
    ...
    public static final GlyphIconType king = new GlyphIconType("king");
    public static final GlyphIconType knight = new GlyphIconType("knight");
    public static final GlyphIconType lamp = new GlyphIconType("lamp");
    public static final GlyphIconType leaf = new GlyphIconType("leaf");
    public static final GlyphIconType levelup = new GlyphIconType("level-up");
    ...
    public static final GlyphIconType menudown = new GlyphIconType("menu-down");
    public static final GlyphIconType menuhamburger = new GlyphIconType("menu-hamburger");
    public static final GlyphIconType menuleft = new GlyphIconType("menu-left");
    public static final GlyphIconType menuright = new GlyphIconType("menu-right");
    public static final GlyphIconType menuup = new GlyphIconType("menu-up");
    ...
    public static final GlyphIconType modalwindow = new GlyphIconType("modal-window");
    ...
    public static final GlyphIconType objectalignbottom = new GlyphIconType("object-align-bottom");
    public static final GlyphIconType objectalignhorizontal = new GlyphIconType("object-align-horizontal");
    public static final GlyphIconType objectalignleft = new GlyphIconType("object-align-left");
    public static final GlyphIconType objectalignright = new GlyphIconType("object-align-right");
    public static final GlyphIconType objectaligntop = new GlyphIconType("object-align-top");
    public static final GlyphIconType objectalignvertical = new GlyphIconType("object-align-vertical");
    public static final GlyphIconType off = new GlyphIconType("off");
    public static final GlyphIconType oil = new GlyphIconType("oil");
    ...
    public static final GlyphIconType openfile = new GlyphIconType("open-file");
    public static final GlyphIconType optionhorizontal = new GlyphIconType("option-horizontal");
    public static final GlyphIconType optionvertical = new GlyphIconType("option-vertical");
    public static final GlyphIconType paperclip = new GlyphIconType("paperclip");
    public static final GlyphIconType paste = new GlyphIconType("paste");
    public static final GlyphIconType pause = new GlyphIconType("pause");
    public static final GlyphIconType pawn = new GlyphIconType("pawn");
    ...
    public static final GlyphIconType piggybank = new GlyphIconType("piggy-bank");
    ...
    public static final GlyphIconType queen = new GlyphIconType("queen");
    ...
    public static final GlyphIconType ruble = new GlyphIconType("ruble");
    public static final GlyphIconType save = new GlyphIconType("save");
    public static final GlyphIconType savefile = new GlyphIconType("save-file");
    public static final GlyphIconType saved = new GlyphIconType("saved");
    public static final GlyphIconType scale = new GlyphIconType("scale");
    public static final GlyphIconType scissors = new GlyphIconType("scissors");
    ...
    public static final GlyphIconType subscript = new GlyphIconType("subscript");
    public static final GlyphIconType subtitles = new GlyphIconType("subtitles");
    public static final GlyphIconType sunglasses = new GlyphIconType("sunglasses");
    public static final GlyphIconType superscript = new GlyphIconType("superscript");
    ...
    public static final GlyphIconType tent = new GlyphIconType("tent");
    public static final GlyphIconType textbackground = new GlyphIconType("text-background");
    public static final GlyphIconType textcolor = new GlyphIconType("text-color");
    public static final GlyphIconType textheight = new GlyphIconType("text-height");
    public static final GlyphIconType textsize = new GlyphIconType("text-size");
    ...
    public static final GlyphIconType trianglebottom = new GlyphIconType("triangle-bottom");
    public static final GlyphIconType triangleleft = new GlyphIconType("triangle-left");
    public static final GlyphIconType triangleright = new GlyphIconType("triangle-right");
    public static final GlyphIconType triangletop = new GlyphIconType("triangle-top");
    ...
    public static final GlyphIconType yen = new GlyphIconType("yen");
