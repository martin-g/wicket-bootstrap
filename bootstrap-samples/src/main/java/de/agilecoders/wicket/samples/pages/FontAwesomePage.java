...
public class FontAwesomePage extends BasePage<Void> {
	...
	public FontAwesomePage(final PageParameters varParameters) {
		...
		// larger icons
		add(new Icon("large-fa", FontAwesomeIconTypeBuilder.on(FontAwsomeGraphic.camera_retro).size(Size.large).build()));
		add(new Icon("2x-fa", FontAwesomeIconTypeBuilder.on(FontAwsomeGraphic.camera_retro).size(Size.two).build()));
		add(new Icon("3x-fa", FontAwesomeIconTypeBuilder.on(FontAwsomeGraphic.camera_retro).size(Size.three).build()));
		add(new Icon("4x-fa", FontAwesomeIconTypeBuilder.on(FontAwsomeGraphic.camera_retro).size(Size.four).build()));
		add(new Icon("5x-fa", FontAwesomeIconTypeBuilder.on(FontAwsomeGraphic.camera_retro).size(Size.five).build()));
