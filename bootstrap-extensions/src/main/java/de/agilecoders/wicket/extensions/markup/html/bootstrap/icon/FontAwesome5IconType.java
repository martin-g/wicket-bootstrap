...
public class FontAwesome5IconType extends IconType {
    ...
    public static final FontAwesome5IconType haykal_s = on(FontAwesome5Solid.haykal).build();
    ...
    public static final FontAwesome5IconType nintendo_switch = on(FontAwesome5Brand.nintendo_switch).build();
