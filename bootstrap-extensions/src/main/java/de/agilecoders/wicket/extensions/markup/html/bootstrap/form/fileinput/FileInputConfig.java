...
public class FileInputConfig extends AbstractConfig {
	...
	public static final IKey<Boolean> ShowCaption = newKey("showCaption",
			Boolean.TRUE);

	public static final IKey<Boolean> ShowPreview = newKey("showPreview",
			Boolean.TRUE);

	public static final IKey<Boolean> ShowRemove = newKey("showRemove",
			Boolean.TRUE);

	public static final IKey<Boolean> ShowUpload = newKey("showUpload",
			Boolean.TRUE);
	...
	public static final IKey<String> InitialCaption = newKey("initialCaption",
			null);

	public static final IKey<String> BrowseClass = newKey("browseClass",
			"btn btn-primary");

	public static final IKey<String> RemoveClass = newKey("removeClass",
			"btn btn-default");

	public static final IKey<String> UploadClass = newKey(
			"browseClass",
			"btn btn-default "
					+ BootstrapFileInputField.JQUERY_IDENTIFIER_UPLOAD_BUTTON_CLASS);

	public static final IKey<Integer> WrapTextLength = newKey("wrapTextLength",
			250);
