 ...
 *
 * This Selectpicker plugin has changed 'destroy' method.
 * Before modification 'remove' and 'destroy' methods be the same.
 * Now destroy method will remove only generated DOM artifacts.
 */
(function ($) {
    'use strict';
