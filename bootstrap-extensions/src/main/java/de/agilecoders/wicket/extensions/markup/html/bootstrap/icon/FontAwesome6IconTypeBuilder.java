...
public class FontAwesome6IconTypeBuilder {
    ...
    public enum FontAwesome6Solid implements FontAwesome6Graphic {
        ...
        bacteria, bacterium, bag_shopping, bahai, baht_sign, ban, ban_smoking, bandage, barcode, bars_progress, bars,
        ...
        book_medical, book_open_reader, book_open, book_quran, book_skull, bookmark, border_all, border_none,
        ...
        bullseye, burger, burst, bus, bus_simple, business_time, c, cake_candles, calculator, calendar, calendar_check,
        calendar_day, calendar_days, calendar_minus, calendar_plus, calendar_week, calendar_xmark, camera, camera_retro,
        camera_rotate, campground, candy_cane, cannabis, capsules, car, car_battery, car_burst, car_crash, car_on,
        ...
        chevron_left, chevron_right, chevron_up, child, child_dress, child_reaching, child_rifle, children, church,
        ...
        hourglass_empty, hourglass_end, hourglass_start, house, house_chimney_crack, house_chimney_medical,
        ...
        newspaper, not_equal, note_sticky, notes_medical, o, object_group, object_ungroup, oil_can, oil_well, om, otter,
        ...
        pencil, people_arrows_left_right, people_carry_box, people_group, people_line, people_pulling, people_robbery,
        ...
        shield, shield_blank, shield_cat, shield_dog, shield_halved, shield_heart, shield_virus, ship, shirt,
        ...
        staff_aesculapius, stairs, stamp, star, star_and_crescent, star_half, star_half_stroke, star_of_david,
    ...
    public enum FontAwesome6Regular implements FontAwesome6Graphic {
        ...
        hand_pointer, hand_scissors, hand_spock, handshake, hard_drive, heart, hospital, hourglass, id_badge, id_card,
    ...
    public enum FontAwesome6Brand implements FontAwesome6Graphic {
        ...
        blogger_b, bluetooth, bluetooth_b, bootstrap, bots, btc, buffer, buromobelexperte, buy_n_large, buysellads,
        ...
        critical_role, css3, css3_alt, cuttlefish, d_and_d, d_and_d_beyond, dailymotion, dashcube, deezer, delicious,
        deploydog, deskpro, dev, deviantart, dhl, diaspora, digg, digital_ocean, discord, discourse, dochub, docker,
        draft2digital, dribbble, dribbble_square, dropbox, drupal, dyalog, earlybirds, ebay, edge, edge_legacy,
        elementor, ello, ember, empire, envira, erlang, ethereum, etsy, evernote, expeditedssl, facebook, facebook_f,
        facebook_messenger, facebook_square, fantasy_flight_games, fedex, fedora, figma, firefox, firefox_browser,
        ...
        google_pay, google_play, google_plus, google_plus_g, google_plus_square, google_wallet, gratipay, grav,
        gripfire, grunt, guilded, gulp, hacker_news, hacker_news_square, hackerrank, hashnode, hips, hire_a_helper,
        hive, hooli, hornbill, hotjar, houzz, html5, hubspot, ideal, imdb, instagram, instagram_square, instalod,
        intercom, internet_explorer, invision, ioxhost, itch_io, itunes, itunes_note, java, jedi_order, jenkins, jira,
        joget, joomla, js, js_square, jsfiddle, kaggle, keybase, keycdn, kickstarter, kickstarter_k, korvue, laravel,
        lastfm, lastfm_square, leanpub, less, line, linkedin, linkedin_in, linode, linux, lyft, magento, mailchimp,
        mandalorian, markdown, mastodon, maxcdn, mdb, medapps, medium, medrt, meetup, megaport, mendeley, microblog,
        microsoft, mix, mixcloud, mixer, mizuni, modx, monero, napster, neos, nfc_directional, nfc_symbol, nimblr,
        node, node_js, npm, ns8, nutritionix, octopus_deploy, odnoklassniki, odnoklassniki_square, old_republic,
        opencart, openid, opera, optin_monster, orcid, osi, padlet, page4, pagelines, palfed, patreon, paypal, perbyte,
        periscope, phabricator, phoenix_framework, phoenix_squadron, php, pied_piper, pied_piper_alt, pied_piper_hat,
        pied_piper_pp, pied_piper_square, pinterest, pinterest_p, pinterest_square, pix, playstation, product_hunt,
        pushed, python, qq, quinscape, quora, r_project, raspberry_pi, ravelry, react, reacteurope, readme, rebel,
        red_river, reddit, reddit_alien, reddit_square, redhat, renren, replyd, researchgate, resolving, rev,
        rocketchat, rockrms, rust, safari, salesforce, sass, schlix, screenpal, scribd, searchengin, sellcast, sellsy,
        servicestack, shirtsinbulk, shopify, shopware, simplybuilt, sistrix, sith, sitrox, sketch, skyatlas, skype,
        slack, slideshare, snapchat, snapchat_square, soundcloud, sourcetree, speakap, speaker_deck, spotify,
        square_font_awesome, square_font_awesome_stroke, squarespace, stack_exchange, stack_overflow, stackpath,
        staylinked, steam, steam_square, steam_symbol, sticker_mule, strava, stripe, stripe_s, studiovinari,
        stumbleupon, stumbleupon_circle, superpowers, supple, suse, swift, symfony, teamspeak, telegram, tencent_weibo,
        the_red_yeti, themeco, themeisle, think_peaks, tiktok, trade_federation, trello, tumblr, tumblr_square, twitch,
        twitter, twitter_square, typo3, uber, ubuntu, uikit, umbraco, uncharted, uniregistry, unity, unsplash, untappd,
        ups, usb, usps, ussunnah, vaadin, viacoin, viadeo, viadeo_square, viber, vimeo, vimeo_square, vimeo_v, vine, vk,
        vnv, vuejs, watchman_monitoring, waze, weebly, weibo, weixin, whatsapp, whatsapp_square, whmcs, wikipedia_w,
        windows, wirsindhandwerk, wix, wizards_of_the_coast, wodu, wolf_pack_battalion, wordpress, wordpress_simple,
        wpbeginner, wpexplorer, wpforms, wpressr, xbox, xing, xing_square, y_combinator, yahoo, yammer, yandex,
