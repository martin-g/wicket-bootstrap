...
public class FontAwesome5IconTypeBuilder {
    ...
    public enum FontAwesome5Solid implements FontAwesome5Graphic {
        ...
        audio_description, award, baby, baby_carriage, backspace, backward, bacon, bahai, balance_scale_left, balance_scale_right, balance_scale, ban, band_aid,
        ...
        book_open, book_reader, bookmark, border_all, border_none, border_style, bowling_ball, box, box_open, boxes, braille, brain, bread_slice, briefcase,
        ...
        hard_hat, hashtag, hat_cowboy, hat_cowboy_side, hat_wizard, hdd, heading, headphones, headphones_alt, headset, heart, heart_broken,
        ...
        hourglass_start, house_damage, hryvnia, i_cursor, ice_cream, icicles, icons, id_badge, id_card, id_card_alt, igloo,
        ...
        money_check, money_check_alt, monument, moon, mortar_pestle, mosque, motorcycle, mountain, mouse, mouse_pointer,
        ...
        snowflake, snowman, snowplow, socks, solar_panel, sort, sort_alpha_down_alt, sort_alpha_down, sort_alpha_up_alt,
        ...
        vials, video, video_slash, vihara, voicemail, volleyball_ball, volume_down, volume_mute, volume_off, volume_up, vote_yea,
    ...
    public enum FontAwesome5Brand implements FontAwesome5Graphic {
        ...
        centos, chrome, chromecast, cloudscale, cloudsmith, cloudversify, codepen, codiepie, confluence, connectdevelop, contao, cotton_bureau,
        ...
        hire_a_helper, hooli, hornbill, hotjar, houzz, html5, hubspot, ideal, imdb, instagram, intercom, internet_explorer,
        ...
        maxcdn, mdb, medapps, medium, medium_m, medrt, meetup, megaport, mendeley, microblog, microsoft, mix, mixcloud, mizuni, modx,
        monero, napster, neos, nimblr, node, node_js, npm, ns8, nutritionix, odnoklassniki,
        ...
        trello, tripadvisor, tumblr, tumblr_square, twitch, twitter, twitter_square, typo3, uber, ubuntu, uikit, umbraco,
        uniregistry, unity, untappd, ups, usb, usps, ussunnah, vaadin, viacoin, viadeo, viadeo_square, viber, vimeo,
