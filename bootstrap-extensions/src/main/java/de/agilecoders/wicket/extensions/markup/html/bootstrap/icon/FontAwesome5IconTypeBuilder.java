...
public class FontAwesome5IconTypeBuilder {
    ...
    public enum FontAwesome5Solid implements FontAwesome5Graphic {
        ...
        audio_description, award, baby, baby_carriage, backspace, backward, bacon, balance_scale_left, balance_scale_right, balance_scale, ban, band_aid,
        ...
        hard_hat, hashtag, hat_cowboy, hat_cowboy_side, hat_wizard, haykal, hdd, heading, headphones, headphones_alt, headset, heart, heart_broken,
    ...
    public enum FontAwesome5Brand implements FontAwesome5Graphic {
        ...
        maxcdn, mdb, medapps, medium, medium_m, medrt, meetup, megaport, mendeley, microsoft, mix, mixcloud, mizuni, modx,
