...
public class FontAwesome5IconTypeBuilder {
    ...
    public enum FontAwesome5Solid implements FontAwesome5Graphic {
        ...
        fire_extinguisher, first_aid, fish, fist_raised, flag, flag_checkered, flag_usa, flask, flushed, folder, font_awesome_logo_full,
    ...
    public enum FontAwesome5Regular implements FontAwesome5Graphic {
        ...
        file_image, file_pdf, file_powerpoint, file_video, file_word, flag, flushed, folder, font_awesome_logo_full, folder_open, frown,
