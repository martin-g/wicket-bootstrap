...
public class FontAwesomeIconTypeBuilder {
    ...
    public enum FontAwesomeGraphic {
        ...
        binoculars, birthday_cake, bitbucket, bitbucket_square, black_tie, blind, bluetooth, bluetooth_b, bold, bolt,
        bomb, book, bookmark, bookmark_o, braille, briefcase, btc, bug, building, building_o, bullhorn, bullseye, bus,
        buysellads, calculator, calendar, calendar_check_o, calendar_minus_o, calendar_o, calendar_plus_o,
        calendar_times_o, camera, camera_retro, car, caret_down, caret_left, caret_right, caret_square_o_down,
        ...
        dribbble, dropbox, drupal, edge, edit, eject, ellipsis_h, ellipsis_v, empire, envelope, envelope_o,
        envelope_square, envira, eraser, eur, exchange, exclamation, exclamation_circle, exclamation_triangle, expand,
        expeditedssl, external_link, external_link_square, eye, eyedropper, eye_slash, facebook, facebook_official,
        facebook_square, fast_backward, fast_forward, fax, female, fighter_jet, file, file_archive_o, file_audio_o,
        file_code_o, file_excel_o, file_image_o, file_o, file_pdf_o, file_powerpoint_o, file_text, file_text_o,
        file_video_o, file_word_o, files_o, film, filter, fire, firefox, fire_extinguisher, first_order, flag,
        flag_checkered, flag_o, flash, flask, flickr, floppy_o, folder, folder_o, folder_open, folder_open_o, font,
        fonticons, forumbee, fort_awesome, forward, foursquare, frown_o, futbol_o, gamepad, gavel, gbp, genderless,
        get_pocket, gg, gg_circle, gift, git, git_square, github, github_alt, github_square, gitlab, gittip, glass,
        glide, glide_g, globe, google, google_plus, google_plus_square, google_wallet, graduation_cap, group, h_square,
        hacker_news, hand_lizard_o, hand_o_down, hand_o_left, hand_o_right, hand_o_up, hand_paper_o, hand_peace_o,
        hand_pointer_o, hand_rock_o, hand_scissors_o, hand_spock_o, hashtag, hdd_o, header, headphones, heart, heart_o,
        heartbeat, history, home, hospital_o, hourglass, hourglass_end, hourglass_half, hourglass_o, hourglass_start,
        houzz, html5, i_cursor, ils, inbox, indent, industry, info, info_circle, inr, instagram, internet_explorer,
        ...
        mars_stroke_v, maxcdn, meanpath, medium, medkit, meh_o, mercury, microphone, microphone_slash, minus, minus_circle, 
        ...
        power_off, print, product_hunt, puzzle_piece, px500, qq, qrcode, question, question_circle, question_circle_o,
        quote_left, quote_right, random, rebel, recycle, reddit, reddit_alien, reddit_square, refresh, registered, remove, renren, 
        ...
        smile_o, snapchat, snapchat_ghost, snapchat_square, sort, sort_alpha_asc, sort_alpha_desc, sort_amount_asc,
        ...
        superscript, table, tablet, tachometer, tag, tags, tasks, taxi, television, tencent_weibo, terminal, text_height,
        text_width, th, th_large, th_list, themeisle, thumb_tack, thumbs_down, thumbs_o_down, thumbs_o_up, thumbs_up,
        ticket, times, times_circle, times_circle_o, tint, toggle_down, toggle_left, toggle_off, toggle_on, toggle_right,
        ...
        university, unlink, unlock, unlock_alt, unsorted, upload, usb, usd, user, user_md, user_plus, user_secret,
        user_times, users, venus, venus_double, venus_mars, viacoin, viadeo, viadeo_square, video_camera, vimeo,
        vimeo_square, vine, vk, volume_control_phone, volume_down, volume_off, volume_up, warning, weelchair,
        wheelchair_alt, weibo, weixin, whatsapp, wheelchair, wifi, wikipedia_w, windows, wordpress, wpbeginner, wpforms,
        wrench, xing, xing_square, y_combinator, yahoo, yelp, yoast, youtube, youtube_play, youtube_square;
    }
