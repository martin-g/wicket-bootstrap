...
public class FontAwesomeIconTypeBuilder {
	...
	public static enum FontAwesomeGraphic {
		...
		caret_square_o_left, caret_square_o_right, caret_square_o_up, caret_up, certificate, chain, chain_broken,
		check, check_circle, check_circle_o, check_minus_square, check_minus_square_o, check_square, check_square_o,
		check_sign, chevron_circle_down, chevron_circle_left, chevron_circle_right, chevron_circle_up, chevron_down,
		chevron_left, chevron_right, chevron_up, circle, circle_o, clipboard, clock_o, cloud, cloud_download,
		cloud_upload, cny, code, code_fork, coffee, cog, cogs, collapse, collapse_alt, collapse_top, columns, comment,
		comment_o, comments, comments_o, compass, copy, credit_card, crop, crosshairs, css3, cut, cutlery, dashboard,
		dedent, desktop, dot_circle_o, download, dribbble, dropbox, edit, eject, ellipsis_h, ellipsis_v, envelope,
		envelope_o, eraser, eur, exchange, exclamation, exclamation_circle, exclamation_triangle, expand,
		external_link, external_link_square, eye, eye_slash, facebook, facebook_square, fast_backward, fast_forward,
		female, fighter_jet, file, file_o, file_text, file_text_o, files_o, film, filter, fire, fire_extinguisher,
		flag, flag_checkered, flag_o, flash, flask, flickr, floppy_o, folder, folder_o, folder_open, folder_open_o,
		font, forward, foursquare, frown_o, gamepad, gavel, gbp, gift, github, github_alt, github_sign, gittip, glass,
		globe, google_plus, google_plus_square, group, h_square, hand_o_down, hand_o_left, hand_o_right, hand_o_up,
		hdd_o, headphones, heart, heart_o, home, hospital_o, html5, inbox, indent, info, info_circle, inr, instagram,
		italic, jpy, key, keyboard_o, krw, laptop, leaf, legal, lemon_o, level_down, level_up, lightbulb_o, link,
		linkedin, linkedin_square, linux, list, list_alt, list_ol, list_ul, location_arrow, lock, long_arrow_down,
		...
		square_o, stack_exchange, star, star_o, star_half, star_half_o, step_backward, step_forward, stethoscope, stop,
		strikethrough, subscript, suitcase, sun_o, superscript, table, tablet, tachometer, tag, tags, tasks, terminal,
		text_height, text_width, th, th_large, th_list, thumb_tack, thumbs_down, thumbs_o_down, thumbs_o_up, thumbs_up,
		ticket, times, times_circle, times_circle_o, tint, toggle_down, toggle_left, toggle_right, toggle_up, trash_o,
		trello, trophy, truck, tumblr, tumblr_square, turkish_lira, twitter, twitter_square, umbrella, underline, undo,
		unlink, unlock, unlock_alt, unsorted, upload, usd, user, user_md, users, vimeo_square, video_camera, vk,
		volume_down, volume_off, volume_up, warning, weelchair, weibo, windows, wrench, xing, xing_square, youtube,
		youtube_play, youtube_square, won;
	}
