...
public class FontAwesomeIconTypeBuilder {
    ...
    public enum FontAwesomeGraphic {
        adjust, adn, align_center, align_justify, align_left, align_right, amazon, ambulance, anchor, android, 
        ...
        balance_scale, ban, bar_chart_o, barcode, bars, battery_empty, battery_full, battery_half, battery_quarter, 
        battery_three_quarters, bed, beer, behance, behance_square, bell, bell_o, bell_slash, bell_slash_o, bicycle, 
        binoculars, birthday_cake, bitbucket, bitbucket_square, black_tie, bluetooth, bluetooth_b, bold, bolt, bomb, 
        ...
        clipboard, clock_o, clone, cloud, cloud_download, cloud_upload, cny, code, code_fork, codepen, codiepie, 
        coffee, cog, cogs, collapse, collapse_alt, collapse_top, columns, comment, comment_o, commenting, commenting_o, 
        comments, comments_o, compass, compress, connectdevelop, contao, copy, copyright, creative_commons, credit_card, 
        credit_card_alt, crop, crosshairs, css3, cube, cubes, cut, cutlery, database, dashboard, dashcube, dedent, 
        delicious, desktop, deviantart, diamond, digg, dot_circle_o, download, dribbble, dropbox, drupal, edge, edit, 
        eject, ellipsis_h, ellipsis_v, empire, envelope, envelope_o, envelope_square, eraser, eur, exchange, 
        exclamation, exclamation_circle, exclamation_triangle, expand, expeditedssl, external_link, 
        external_link_square, eye, eyedropper, eye_slash, facebook, facebook_official, facebook_square, fast_backward, 
        fast_forward, fax, female, fighter_jet, file, file_archive_o, file_audio_o, file_code_o, file_excel_o, 
        file_image_o, file_o, file_pdf_o, file_powerpoint_o, file_text, file_text_o, file_video_o, file_word_o, files_o, 
        film, filter, fire, firefox, fire_extinguisher, flag, flag_checkered, flag_o, flash, flask, flickr, floppy_o, 
        folder, folder_o, folder_open, folder_open_o, font, fonticons, forumbee, fort_awesome, forward, foursquare, 
        frown_o, futbol_o, gamepad, gavel, gbp, genderless, get_pocket, gg, gg_circle, gift, git, git_square, github, 
        github_alt, github_square, gittip, glass, globe, google, google_plus, google_plus_square, google_wallet, 
        graduation_cap, group, h_square, hacker_news, hand_lizard_o, hand_o_down, hand_o_left, hand_o_right, hand_o_up, 
        hand_paper_o, hand_peace_o, hand_pointer_o, hand_rock_o, hand_scissors_o, hand_spock_o, hashtag, hdd_o, header, 
        headphones, heart, heart_o, heartbeat, history, home, hospital_o, hourglass, hourglass_end, hourglass_half, 
        hourglass_o, hourglass_start, houzz, html5, i_cursor, ils, inbox, indent, industry, info, info_circle, inr, 
        instagram, internet_explorer, ioxhost, italic, joomla, jpy, jsfiddle, key, keyboard_o, krw, language, laptop, 
        lastfm, lastfm_square, leaf, leanpub, legal, lemon_o, level_down, level_up, life_ring, lightbulb_o, line_chart, 
        link, linkedin, linkedin_square, linux, list, list_alt, list_ol, list_ul, location_arrow, lock, long_arrow_down, 
        long_arrow_left, long_arrow_right, long_arrow_up, magic, magnet, mail_forward, mail_reply, mail_reply_all, male,
        map, map_marker, map_o, map_pin, map_signs, mars, mars_double, mars_stroke, mars_stroke_h, mars_stroke_v, 
        maxcdn, meanpath, medium, medkit, meh_o, mercury, microphone, microphone_slash, minus, minus_circle, 
        ...
        power_off, print, product_hunt, puzzle_piece, px500, qq, qrcode, question, question_circle, quote_left, 
        quote_right, random, rebel, recycle, reddit, reddit_alien, reddit_square, refresh, registered, remove, renren, 
        ...
        share_square_o, sheqel, shield, ship, shirtsinbulk, shopping_bag, shopping_basket, shopping_cart, sign_blank, 
        signal, simplybuilt, sign_in, sign_out, sitemap, skyatlas, skype, slack, sliders, slideshare, smile_o, sort, 
        sort_alpha_asc, sort_alpha_desc, sort_amount_asc, sort_amount_desc, sort_asc, sort_numeric_asc, 
        sort_numeric_desc, sort_desc, soundcloud, space_shuttle, spinner, spoon, spotify, square, square_o, 
        stack_exchange, stack_overflow, star, star_o, steam, steam_square, star_half, star_half_o, step_backward,
        step_forward, stethoscope, sticky_note, sticky_note_o, stop, stop_circle, stop_circle_o, street_view, 
        ...
        unlock, unlock_alt, unsorted, upload, usb, usd, user, user_md, user_plus, user_secret, user_times, users, venus,
